...
import br.com.oficina.ordem_servico.adapter.out.client.feign.OrcamentoFeignClient;
import br.com.oficina.ordem_servico.adapter.out.client.feign.dto.ClienteRequest;
import br.com.oficina.ordem_servico.adapter.out.client.feign.dto.CriarOrcamentoRequest;
import br.com.oficina.ordem_servico.adapter.out.client.feign.dto.ItemOrcamentoRequest;
import br.com.oficina.ordem_servico.adapter.out.client.feign.dto.VeiculoRequest;
import br.com.oficina.ordem_servico.adapter.out.client.feign.dto.CriarOrcamentoResponse; // New Import
import br.com.oficina.ordem_servico.core.domain.entity.OrdemServico;
import br.com.oficina.ordem_servico.core.port.out.OrdemServicoOrcamentoPort;
